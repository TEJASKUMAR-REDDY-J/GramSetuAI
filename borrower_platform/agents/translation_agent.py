...
5. Only provide the translation, no explanations
6. Do not include phrases like "Translation:" or "ವಿವರ:" or labels
7. Return only the translated text without any prefixes or suffixes

English text: {text}

Provide only the {target_language.title()} translation:"""
