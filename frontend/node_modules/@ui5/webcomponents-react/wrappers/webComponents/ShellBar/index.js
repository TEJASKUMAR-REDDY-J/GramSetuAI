 ...
 */
const ShellBar = withWebComponent('ui5-shellbar', ['accessibilityAttributes', 'notificationsCount', 'primaryTitle', 'secondaryTitle'], ['disableSearchCollapse', 'hideSearchButton', 'showNotifications', 'showProductSwitch', 'showSearchField'], ['assistant', 'branding', 'content', 'logo', 'menuItems', 'profile', 'searchField', 'startButton'], ['content-item-visibility-change', 'logo-click', 'menu-item-click', 'notifications-click', 'product-switch-click', 'profile-click', 'search-button-click', 'search-field-toggle']);
