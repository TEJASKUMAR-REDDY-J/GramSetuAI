 ...
 */
const Select = withWebComponent('ui5-select', ['accessibleName', 'accessibleNameRef', 'name', 'tooltip', 'value', 'valueState'], ['disabled', 'readonly', 'required'], ['label', 'valueStateMessage'], ['change', 'close', 'live-change', 'open']);
